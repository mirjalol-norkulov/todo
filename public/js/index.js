...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    subTasks: function subTasks() {
      return this.todo.sub_tasks.sort(function (subTask) {
        return subTask.done ? 1 : -1;
      });
    }
  },
  components: {
...
/* harmony import */ var _Todo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Todo */ "./resources/js/components/Todo.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onSortOrderChange: function onSortOrderChange(event) {
...
// module
exports.push([module.i, ".profile[data-v-3bd692e4] {\n  position: absolute;\n  top: 1rem;\n  right: 1rem;\n}\n", ""]);
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "profile flex" }, [
    _c(
      "div",
      { staticClass: "py-1 px-2 rounded-l-full text-sm bg-red-500 text-white" },
    ...
    _c(
      ...
      {
        staticClass:
          "py-1 px-2 focus:outline-none rounded-r-full bg-red-500 text-white",
        on: { click: _vm.logout }
      },
      [_c("i", { staticClass: "lni-exit" })]
    )
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "rounded p-5 items-center" }, [
        _c("div", { staticClass: "flex items-center flex-grow" }, [
          _c("div", { staticClass: "flex-grow font-medium text-md" }, [
      ...
      _vm._v(" "),
      _vm.todo.sub_tasks.length
        ? _c("div", { staticClass: "mt-3 border-t border-gray-200 p-5" }, [
            ...
            _c(
              "ol",
              { staticClass: "list-decimal p-5" },
              _vm._l(_vm.subTasks, function(subTask, index) {
                return _c("li", [
                  _c("span", { staticClass: "text-sm" }, [
                    ...
                    subTask.done
                      ? _c("i", {
                          staticClass:
                            "ml-1 text-green-500 lni-check-mark-circle"
                        })
                      : _vm._e()
                  ])
                ])
...
var render = function() {
  ...
  return _c(
    "draggable",
    { attrs: { list: _vm.todos }, on: { change: _vm.onSortOrderChange } },
