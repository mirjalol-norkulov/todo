        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                _context.next = 7;
                return this.$axios.post(this.$refs.form.getAttribute("action"), _.pick(this.$data, ["email", "password"]));
...
module.exports = __webpack_require__(/*! C:\OSPanel\domains\todo.loc\resources\js\login.js */"./resources/js/login.js");
